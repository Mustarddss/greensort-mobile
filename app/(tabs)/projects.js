...
import { StyleSheet, Text, View, Image, TouchableOpacity, ScrollView, FlatList, BackHandler, StatusBar } from 'react-native';
...
export default function ProjectsPage() {
  ...
  const insets = useSafeAreaInsets(); // 👈 Para sa dynamic status bar height
...
const styles = StyleSheet.create({
  ...
  header: { 
    backgroundColor: '#00C853', // Binago ko pabalik sa Green
    paddingBottom: 25, 
  ...
  // 🟢 3-COLUMN FLEXBOX PARA PERFECT CENTER
  headerRow: { 
    flexDirection: 'row', 
  ...
  headerSide: { width: 50, alignItems: 'flex-start' }, // Space para sa back button at invisible spacer
  headerCenter: { flex: 1, alignItems: 'center' },
  
  headerTitle: { color: 'white', fontSize: 20, fontWeight: 'bold' },
  headerSubtitle: { color: 'rgba(255,255,255,0.9)', fontSize: 12, marginTop: 2, textAlign: 'center' },
  ...
  squareBullet: { width: 8, height: 8, backgroundColor: '#00C853', marginRight: 10, borderRadius: 2 }, // Ginawang green din
  listText: { color: '#555', fontSize: 14 },
  stepItem: { flexDirection: 'row', marginBottom: 15 },
  stepNumberBox: { width: 28, height: 28, backgroundColor: '#00C853', borderRadius: 6, justifyContent: 'center', alignItems: 'center', marginRight: 15 }, // Ginawang green din
